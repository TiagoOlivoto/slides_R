...
<!-- flax |> image_horizontal() |> image_index("all") -->
<!-- ``` -->
<!-- ] -->

<!-- .panel[.panel-name[Identificando a segmentação] -->
<!-- ```{r, out.width='100%', fig.width=20, fig.height=10} -->
<!-- flax |> image_horizontal() |> image_segment("all") -->
<!-- ``` -->
<!-- ] -->
...
<!-- ``` -->
<!-- <i class =" fa fa -book"></i>Veja o artigo aqui! [here](https://besjournals.onlinelibrary.wiley.com/doi/abs/10.1111/2041-210X.13803) -->
<!-- ] -->
...
<!-- ``` -->
<!-- <i class =" fa fa -book"></i>Veja o artigo aqui! [here](https://link.springer.com/article/10.1007/s40858-021-00487-5) -->
<!-- ] -->
